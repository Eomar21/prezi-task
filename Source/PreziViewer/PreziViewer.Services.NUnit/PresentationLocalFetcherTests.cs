...
namespace PreziViewer.Services.NUnit
{
    public class PresentationLocalFetcherTest
    {
        ...
        public async Task TryGetOnlinePresentations_ShouldReturnPresentations_WhenValidJsonExists()
        {
            ...
            {
                new Presentation { Id = Guid.NewGuid(), Title = "Fake Presentation 1", Description = "Fake Desc 1" , ThumbnailUrl = new Uri("https://Prezi.com/thumbnail.jpg")},
                new Presentation { Id = Guid.NewGuid(), Title = "Fake Presentation 2", Description = "Fake Desc 2", ThumbnailUrl=new Uri("https://Prezi.com/thumbnail.jpg") }
            };
